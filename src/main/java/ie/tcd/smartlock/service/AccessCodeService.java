...
import ie.tcd.smartlock.mapper.AccessCodeMapper;
import ie.tcd.smartlock.model.entity.AccessCode;
import ie.tcd.smartlock.model.entity.Log;
import ie.tcd.smartlock.model.vo.req.AccessCodeReqMqtt;
...
public class AccessCodeService extends ServiceImpl<AccessCodeMapper, AccessCode> {
    ...
    public String generateCode(Long deviceId, LocalDateTime from, LocalDateTime to, String owner) {
        ...
        AccessCodeReqMqtt codeReqMqtt = AccessCodeReqMqtt.builder()
                ...
                .validTo(to)
                .build();
        String json = objectMapper.writeValueAsString(codeReqMqtt);
    ...
    public void getAllAccessCode(AccessCodeRespMqtt deviceIdResp, Long deviceId) {
        ...
        mqttGateway.send("server/" + deviceId + "/all-code", objectMapper.writeValueAsString(reqMqtts));
